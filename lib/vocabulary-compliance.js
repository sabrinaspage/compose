/**
 * vocabulary-compliance.js — deterministic, consumer-side port of the Python
 * Stratum `vocabulary_compliance` ensure builtin
 * (stratum-mcp/src/stratum_mcp/spec.py).
 *
 ...
 * formats match the Python builtin so tagVocabularyViolations classifies them.
 */
