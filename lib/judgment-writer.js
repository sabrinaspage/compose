...
// RFC 3339 date-time, matching the contract's `format: "date-time"` so the
// precheck is never weaker than final schema validation (a laxer precheck
// would let malformed input reach the idempotency cache before validation).
