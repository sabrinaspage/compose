...
const GOAL_EXECUTORS = Object.freeze({
  ...
  // S1 happy path: build the intent, persist it, and publish it under the held
  // lock. The legality-window guard, the wholesale non-migrate fence, and the
  // completion / already-migrated / revived-objective diagnostics are S2.
