...
| 3 | COMP-JUDGMENT-STORES | Writer extensions — person/situation/goal/resolution-package record kinds, generated projections, invariants as rejected writes (the only door for every store; manual Writer box + ledger seq 112) | IN_PROGRESS |
