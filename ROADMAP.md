...
| 5 | COMP-JUDGMENT-GOAL-MIGRATE | Intent-backed objective→goal migration: replay-durable compound op, dual-read cutover, intent-aware snapshot, position retirement. Split from COMP-JUDGMENT-STORES at gate round 5; depends on the goal store shipping first | PLANNED |
